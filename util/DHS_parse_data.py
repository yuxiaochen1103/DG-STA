        ...
        for f_id in range(1,3):
            for sub_id in range(1,21):
                for e_id in range(1,6):
                    src_path = "/gpu2/yc984/hand/dataset/DHG2016/gesture_{}/finger_{}/subject_{}/essai_{}/skeleton_world.txt".format(g_id, f_id, sub_id, e_id)
...
def get_valid_frame(video_data):
    ...
    info_path = "/gpu2/yc984/hand/dataset/DHG2016/informations_troncage_sequences.txt"

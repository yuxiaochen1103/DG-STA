...
def split_train_test(data_cfg):
    ...
    train_path = "/gpu2/yc984/hand/dataset/SHREC17/HandGestureDataset_SHREC2017/train_gestures.txt"
    ...
    test_path = "/gpu2/yc984/hand/dataset/SHREC17/HandGestureDataset_SHREC2017/test_gestures.txt"
